...
# 輸出的 JSON 檔案名稱
output_filename = "Svm" + stock_id + "_2.json"
...
try:
    ...
    df_analysis = pd.read_csv("5DayRecallanalysis_ternary" + stock_id + ".csv", encoding="utf-8-sig", parse_dates=["date"], index_col="date")
    df_C = pd.read_csv("5DayRecallanalysis_ternaryC.csv", encoding="utf-8-sig", parse_dates=["date"], index_col="date")
